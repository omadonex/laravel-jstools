...
$.fn.omxInputFilter = function(inputFilter: any): JQuery {
    return this.on("input keydown keyup mousedown mouseup select contextmenu drop", function(this: (HTMLInputElement | HTMLTextAreaElement) & { oldValue: string; oldSelectionStart: number | null, oldSelectionEnd: number | null }) {
